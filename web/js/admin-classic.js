(() => {
  ...
  async function start() {
    ...
    function correction(i){const s=state.services[i],f=$('#service-form');$('#service-id').value=s.id;F.forEach(k=>{if(f.elements[k])f.elements[k].value=s[k]??''});$('#save-service').innerHTML=`${icon('floppy-disk')} Guardar corrección`;}
